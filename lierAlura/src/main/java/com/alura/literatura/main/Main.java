...
public class Main {
    ...
    public void muestraElMenu() {
        ...
        do {
            ...
            teclado.nextLine();
            if (eleccion >= 0 && eleccion <= 5) { // Verificar si la opción es válida
                switch (eleccion) {
    ...
    private LibroEntity getDatosLibro() {
        System.out.println("Ingrese el Nombre del Libro que Quieres Encontrar: ");
        ...
        return Optional.ofNullable(datos)
                ...
                .orElseGet(() -> {
                    System.out.println("No se encontraron resultados en su búsqueda.");
                    return null;
                });
    }
